...
export default function ConsentModal({ isOpen, onAccept, onDecline }: ConsentModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto font-sans">
        <div className="p-6">
          ...
          <p className="mb-2 text-sm leading-relaxed">Within this research project, we will collect and register the following:</p>
          <ul className="list-disc pl-6 mb-6 text-sm leading-relaxed">
          ...
          <p className="mb-6 text-sm leading-relaxed">
            KTH Data Protection Officer (DPO): <a href="mailto:dataskyddsombud@kth.se" className="text-blue-600 hover:underline">dataskyddsombud@kth.se</a>
          </p>
          <p className="mb-6 text-sm leading-relaxed">
            You also have the right to lodge a complaint with the Swedish Privacy Protection Agency (<a href="https://www.imy.se" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">imy.se</a>).
          </p>
          
          <h3 className="text-xl font-semibold mb-3 text-indigo-700">Project Responsibility and Contact Information</h3>
          <p className="mb-2 text-sm leading-relaxed">Project Responsible (Researcher): <a href="mailto:gidiotis@kth.se" className="text-blue-600 hover:underline">gidiotis@kth.se</a></p>
          <p className="mb-2 text-sm leading-relaxed">Principal Research Supervisor: <a href="mailto:stefanhr@kth.se" className="text-blue-600 hover:underline">stefanhr@kth.se</a></p>
          <p className="mb-6 text-sm leading-relaxed">Mailing Address: BRINELLVÄGEN 68, 10044 STOCKHOLM, SWEDEN</p>
          <p className="mb-6 text-sm leading-relaxed">
          ...
          <div className="flex justify-center space-x-4 mt-8">
            <button 
              onClick={onDecline}
              className="px-6 py-2 rounded-md bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium text-sm"
            >
              Decline
            </button>
            <button 
              onClick={onAccept}
              className="px-6 py-2 rounded-md bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium text-sm"
            >
              I Accept
            </button>
          </div>
