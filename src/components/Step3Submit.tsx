      ...
      <div className="text-center py-12">
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-8">
            We appreciate your contribution to the EduFutures Research project.
          </p>
          <button
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Only if you'd like to be further contacted about this research.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className={`
              py-3 px-8 rounded-lg text-white font-medium transition-all duration-300
              ${isSubmitting
